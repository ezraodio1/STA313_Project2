...
#2020
file_path <- "data for app/2020.txt"
...
#2016
file_path <- "data for app/2016.txt"
...
#2012
file_path <- "data for app/2012.txt"
...
#2008
file_path <- "data for app/2008.txt"
...
#2004
file_path <- "data for app/2004.txt"
...
#2000
file_path <- "data for app/2000.txt"
...
```{r}
#reading in longitude and latitude data
geography_nc <- read_csv("data for app/NCCounties2.csv")
...
#election_data <- left_join(election_data, separate_geo, by = "County")
#election_data <- select(election_data, -Lat.x.x, -Long.x.x, -Lat.y.y, -Long.y.y)
```
