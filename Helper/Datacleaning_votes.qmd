...
election_data2 <- left_join(election_data, separate_geo, by = "County")
election_data2 <- select(election_data2, -Lat.x, -Long.x)



#reshaping total votes into dem and rep votes
election_data3 <- election_data2 |>
  pivot_wider(
...
write_csv(election_data3, "data/election-data3.csv")
