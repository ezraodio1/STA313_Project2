...
#election_data_wide_geo <- left_join(election_data_wide_geo, population2000, by = c("County", "Year"))
#election_data_wide_geo <- left_join(election_data_wide_geo, population2004, by = c("County", "Year", "Population"))
#election_data_wide_geo <- left_join(election_data_wide_geo, population2008, by = c("County", "Year", "Population"))

#election_data_wide_geo |>
#  select(-population.x) |>
# select(-population.y) |>
#  select(-population)
